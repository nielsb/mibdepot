                     Compaq Insight Management MIB

                              README.TXT

This document contains information on how to use the files provided on
the Compaq Management CD in the \TOOLKIT\MIBS directory.  It is intended
to give the reader experienced in SNMP management products a summary of
the steps required to start using the Compaq Insight MIB as soon as
possible. For more complete information, please refer to the Integrating
Compaq Insight Manager with Enterprise Management Platforms Technote
or the Integrating Compaq Insight Manager with ManageWise Technote.  These
and other Technotes are available located in the \DOCS\ENG directory and
available on the Compaq World Wide Web server at http://www.compaq.com.  If
you wish to get a bound hardcopy version of any of the Compaq Technotes,
contact your Authorized Compaq Reseller or call one of the following numbers:

     In the United States, call 1-800-952-7689.
     In Canada, call 1-800-263-5868.
     Outside the US and Canada, call 1-317-364-7281.
...
1.0  Introduction to the Compaq Insight Management MIB

2.0  Compaq Insight Management Information Base Organization
...
Compaq Insight Management Information Base (MIB) into SNMP network
management applications.  Compaq provides these files for inclusion
into SNMP network management applications such as SunNet Manager from
SunConnect, HP OpenView Network Node Manager from Hewlett Packard,
NetView for AIX from IBM and ManageWise from Novell.  These files allow the
user to integrate Compaq server management into an existing work group
or enterprise management environment.  For an in-depth tool to monitor
your Compaq servers, consider using Compaq Insight Manager, which
provides a comprehensive management interface to the complete Insight
MIB.  Compaq Insight Manager is an easy to use application based on
the Microsoft Windows environment.


2.0  COMPAQ INSIGHT MANAGEMENT INFORMATION BASE ORGANIZATION

The Compaq Insight Management MIB is a modular definition that follows
IETF RFC 1212 for manageable objects and RFC 1215 for traps.  Each piece
...
about the different files that compose the Compaq Insight Management
MIB.
 ...
 CPQSINFO.MIB   Compaq Specific PC Server information

 CPQHOST.MIB    Host Server Operating System information

 CPQIDA.MIB     Compaq Intelligent Drive Array information

 CPQIDE.MIB     Compaq IDE information

 CPQSCSI.MIB    Compaq SCSI Device information

 CPQSTSYS.MIB   Compaq Storage Systems information

 CPQHLTH.MIB    Compaq Server Health information

 CPQTHRSH.MIB   Settable Threshold information

 CPQUPS.MIB     Compaq Uninterruptible Power Supply (UPS) information

 CPQRECOV.MIB   Compaq Recovery Server information

 CPQSRVMN.MIB   Compaq Server Manager/R information

 CPQSM2.MIB     Compaq Remote Insight information

 CPQCLUS.MIB    Compaq Cluster information

 CPQFCA.MIB     Compaq Fibre Array information

 CPQSTAT.MIB    Compaq External Status information

 CPQNIC.MIB     Compaq Network Interface Card information
...
The Compaq Insight MIBs represent an extension to the standard MIB
information already defined in several standard MIB documents (for
example, RFC 1213 or RFC 1271).  These Compaq extensions offer
additional information that will be available to any SNMP management
application supporting the Compaq MIBs.

The Compaq MIBs are defined to be modular.  A series of MIBs address
...
(ISA or EISA).  A Compaq system specific MIB provides information about
Compaq specific extensions to the standard PC information.  Other
Compaq MIBs provide information about specific sub-systems developed
by Compaq; for example Drive Array or Server Health sub-systems.

Using the Compaq MIBs in no way affects the standard information already
available with SNMP or the access method for obtaining standard
information.

The Compaq Insight MIBs conform to the Concise MIB format (see section 3.0)
and are suitable for use by most MIB compilers used to assimilate MIB
documents. The main portion of the tree with respect to the Compaq
...
item.  For example the number 1.3.6.1.4.1.232.1 stands for the Compaq
...
Further detail about the groups and objects provided by the Compaq
...
IMPORTS statement.  Some example Compaq group definitions are shown below.
...
As an example, to get the clock speed of a Compaq Server's second
...
Traps are defined in the last section of Compaq MIBs.  Refer to the actual
trap definitions for more information about the traps generated by Compaq
Insight Management Agents.

______________________________________________________________________
Copyright 1992-2000 Compaq Computer Corporation.
All Rights Reserved.
